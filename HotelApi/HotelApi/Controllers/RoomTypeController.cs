...
namespace HotelApi.Controllers
{
    ...
    {
        protected readonly IRoomTypeRepository _repository;
        protected readonly IMapper _mapper;
        protected ResponseApi _response;

        public RoomTypeController(IRoomTypeRepository repository, IMapper mapper)
        {
        ...
        /// <response code="403">Si la llamada no esta autenticada</response>
        /// <response code="404">Si no existe el registro</response>
        [HttpGet("{name}", Name = "GetRoomTypeByName")]
        public async Task<IActionResult> GetRoomTypeName(string name)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateRoomTypeDto model)
        {
        ...
        public async Task<IActionResult> Update([FromBody] RoomTypeDto model)
        {
            ...
            try
            {
                ...
                await _repository.Update(roomType);
